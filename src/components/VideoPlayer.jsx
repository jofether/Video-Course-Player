export default function VideoPlayer({ lesson, isPlaying, onPlayToggle }) {
  return (
    <div className="relative w-full aspect-video bg-black rounded-2xl shadow-2xl border border-slate-700 overflow-hidden group mb-6">
      ...
      <button 
        ...
        className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-24 h-24 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-full flex items-center justify-center hover:shadow-2xl hover:shadow-blue-500/50 transition-all active:scale-95 z-10 text-4xl"
      >
        ▶
      </button>
